...
const Skeleton = (props: SkeletonProps) => {
  ...
  const custom = (
    <ContentLoader
      viewBox="0 0 320 81"
      {...props}
      uniqueKey={uniqueKey || 'loader-custom'}
    >
  ...
  const list = (
    <ContentLoader
      viewBox="0 0 320 145.7"
      {...props}
      uniqueKey={uniqueKey || 'loader-list'}
    >
  ...
  const code = (
    <ContentLoader
      viewBox="0 0 320 63"
      {...props}
      uniqueKey={uniqueKey || 'loader-code'}
    >
  ...
  const description = (
    <ContentLoader
      viewBox="0 0 304 187.6"
      uniqueKey={uniqueKey || 'loader-description'}
      {...props}
    >
  ...
  const bulletList = (
    <ContentLoader
      viewBox="0 0 320 260"
      {...props}
      uniqueKey={uniqueKey || 'loader-bulletList'}
    >
